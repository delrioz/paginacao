...
<br>
    ...
    <div class="card-deck" >
        <div class="card" id="card-cat">
         ...
         $nomePS = "Educacional";?>
          ...
          <div class="card-footer"
            ...
            <a href="/categoria/{{$nomePS}}" class="btn btn-warning">Mais Detalhes</a>
          </div>
                </div>
           ...
           <div class="card-footer"
            style="position:absolute !important; bottom:0 !important; width:100% !important; background-color: transparent !important;text-align: center !important;">
            <a href="/categoria/Serviços%20Gerais%20e%20Limpezas" class="btn btn-warning">Mais Detalhes</a>
          </div>
                </div>
          ...
          <div class="card-footer"
            style="position:absolute !important; bottom:0 !important; width:100% !important; background-color: transparent !important;text-align: center !important;">
            <a href="/categoria/Serviços%20de%20Transportes" class="btn btn-warning">Mais Detalhes</a>
          </div>
                </div>
        ...
        <div class="card" id="card-cat">
           ...
           <div class="card-footer"
            style="position:absolute !important; bottom:0 !important; width:100% !important; background-color: transparent !important;text-align: center !important;">
            <a href="/categoria/{{$ServicosFreela}}" class="btn btn-warning">Mais Detalhes</a>
          </div>
                </div>
        ...
        <div class="card-footer"
          style="position:absolute !important; bottom:0 !important; width:100% !important; background-color: transparent !important;text-align: center !important;">
          <a href="/categoria/{{$ProfissionaisdaSaude}}" class="btn btn-warning">Mais Detalhes</a>
        </div>
                </div>
          ...
          <div class="card-footer"
            style="position:absolute !important; bottom:0 !important; width:100% !important; background-color: transparent !important;text-align: center !important;">
            <a href="/categoria/Alimentícios%20e%20Cozinha" class="btn btn-warning">Mais Detalhes</a>
          </div>
                </div>
      ...
      <div class="card-deck" >
        <div class="card" id="card-cat">
          ...
          <div class="card-footer"
            style="position:absolute !important; bottom:0 !important; width:100% !important; background-color: transparent !important;text-align: center !important;">
            <a href="/categoria/{{$nomeFestivos}}" class="btn btn-warning">Mais Detalhes</a>
          </div>
                </div>
          ...
          <div class="card-footer"
            style="position:absolute !important; bottom:0 !important; width:100% !important; background-color: transparent !important;text-align: center !important;">
            <a href="/categoria/Babás%20e%20Cuidadoras" class="btn btn-warning">Mais Detalhes</a>
          </div>
                </div>
         ...
         ?>
           ...
           <div class="card-footer"
            style="position:absolute !important; bottom:0 !important; width:100% !important; background-color: transparent !important;text-align: center !important;">
            <a href="/categoria/{{$nomeBeleza}}" class="btn btn-warning">Mais Detalhes</a>
          </div>
                </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action = "/listarcategorias/enviar" method="POST">
            @csrf
