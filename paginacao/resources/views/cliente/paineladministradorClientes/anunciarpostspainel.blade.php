...
<div class="card border">
 <div class="card-body">
        <form action="{{ route('meuservicos.store') }}" method="POST">
   @csrf
 ...
 <div class="row">
            ...
            <div class="col">
                <div class="col-md-10">
                    ...
                    <div class="md-form mb-0">
                        <input type="text" class="form-control " id="mei"
                        name="mei" placeholder="Seu Município"
                           required>
                    </div>
                </div>
            </div>
 ...
 <!-- campo4 -->
            <div class="col">
                <label for="name" class="">imagem</label>
                ...
                <div class="col-md-11.5" style="width:995px">
                    <div class="md-form mb-0">
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"
                           ...
                           name="imagem"
                            placeholder="imagem" id="imagem"></textarea>
