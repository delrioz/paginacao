    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <div class="list-group">
          ...
          <a href="/Cportifolio/{{$id}}" class="list-group-item active" id="ativos">Portifólio do Profissional</a>
...
<br>
      ...
      @if($diplomaCertificado != 'default.png')
          <a type="button" class="btn btn-md btn-warning"
            href="/Cdownload/{{$file_name}}">Baixar Certificado</a>
      @endif
        ...
        <div class="card card-outline-secondary my-4">
          ...
          <div class="card-body" >
            ...
            <p>{{ $exp }}</p>
            <small class="text-muted">Experiências de  <a>{{ $nome }}</a></small>
            <hr style="background-color:purple;">
