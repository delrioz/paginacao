...
@if($errors->any())
 ...
 @endif
    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <div class="list-group">
          <a href="/Canuncios/{{$id}}" class="list-group-item active" id="ativos">Sobre o anúncio</a>
          <a href="/Cportifolio/{{$id}}"class="list-group-item">Portifólio do Profissional</a>
          <a href="/Ccontatos/{{$id}}" class="list-group-item">Contatos</a>
        </div>
      </div>
      <!-- /.col-lg-3 -->
  ...
  @if($anuncios->image !=null)
        ...
        <div class="card card-outline-PRIMARY my-4">
        <div class="card-header" id="avaliacoes"  style="text-align:center;
         background-color: #FFA500;"

        >
           <h5><strong style = "text-align:center;color:black!important;" > Veja quem avaliou </strong></h5>
          </div>
          <div class="card-body">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="/Canuncios/avaliar" method="POST">
         @csrf
          <div class="form-group">
            ...
            name="titulo"  maxlength="191"
             required>
          </div>
          <div class="form-group">
            <label for="message-text" class="col-form-label"
            name="comentario" id="comentario">Avaliação</label>
            <textarea class="form-control" name="comentario" id="avaliacao"
            required maxlength="191" ></textarea>
          </div>
              ...
              <input type="hidden" id="clientes_id" name="clientes_id" value="{{ auth()->guard('cliente')-> user()->id  }}" />
