...
h5{
  ...
  @extends('layouts.navbarclientesdetalhes')
    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <div class="list-group">
          <a href="/Canuncios/{{$id}}" class="list-group-item" >Sobre o anúncio</a>
          <a href="/Cportifolio/{{$id}}" class="list-group-item">Portifólio do Profissional</a>
          <a href="/Ccontatos/{{$id}}" class="list-group-item active" id="ativos">Contatos</a>
        </div>
      </div>
      <!-- /.col-lg-3 -->
      ...
      <div class="card mt-4">
                    ...
                    <div class="col-md-12">
                      <div class="contact-form">
                        <div class="form-group">
                          <label class="control-label col-sm-2" for="nome"
                          > Seu Nome:</label>
                          <div class="col-sm-12">
                            <input
                              type="text"
                        ...
                        <div class="form-group">
                          <label class="control-label col-sm-2" for="email">Seu Email:</label>
                          <div class="col-sm-12">
                            <input
                              type="email"
                              class="form-control"
                        ...
                        <div class="form-group">
                         ...
                         <input type="hidden" id="emailDestinatario" name="emailDestinatario" value="{{ $email }}">
                         <input type="hidden" id="tituloAnuncio" name="tituloAnuncio" value="{{ $titulo }}">
                         <input type="hidden" id="categoriaAnuncio" name="categoriaAnuncio" value="{{ $categoria }}">
                         <input type="hidden" id="nameAnunciante" name="nameAnunciante" value="{{ $nameAnunciante }}">

                        </div>
                        <div class="form-group">
                          <label class="control-label col-sm-6" for="mensagem" name = "mensagem" id="mensagem">
                          Sua mensagem:</label>
                          <div class="col-sm-12">
        ...
        <!-- /.card -->
          ...
          <div class="card-header" id="avaliacoes">
            ...
            <div class="card-body">
              <h5 style="color:black;">Gostou? Então entre em contato com quem anunciou</h5>
              <br />
              <button
                type="button"
                ...
                id="botaoModal"
              >Entrar em contato com quem anuncia</button>
              <hr />
            </div>
          </div>
          <!-- /.card -->
