...
@if(session('success'))
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Cadastrando Usuário') }}</div>
        ...
        <div class="col-md-8">
            <div class="card">
              <div class="card-header" style="background-color:orange; text-align:center;">
                <strong><h4>{{ __('Cadastrando Usuário') }}</h4></strong></div>
...
@endsection
nput id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
