    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-5">
						<h2>Categorias <b> em Alta </b></h2>
					</div>
					<div class="col-sm-7">
						<a href="#" class="btn btn-primary" data-toggle="modal" data-target="#squarespaceModal"><i class="fas fa-plus"></i>  <span>Sugerir Categoria</span></a>
...
?>
        ...
        <td>{{$result2}}</td>
        <td>{{$result}}</td>
        <td>{{$acesso->visualizacoes}}</td>
        <td>

							<a  href="/categoria/{{ $acesso->name }}"
  ...
  <div class="modal-dialog">
	<div class="modal-content">
		...
		<div class="modal-body">
            ...
            <h2 style="text-align:center; color:purple;">Sugerir nova Categoria</h2>
            <!-- content goes here -->
              ...
              <div class="modal-dialog" role="document">
                  <div class="modal-content">
                      ...
                      <div class="modal-footer">
                          ...
                          <button type="submit" class="btn btn-warning" id="buttonenv">Enviar sugestão</button>
                      </div>
          </form>
        </div>
        </div>
