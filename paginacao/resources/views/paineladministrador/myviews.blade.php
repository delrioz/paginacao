    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-5">
						<h2>Controle <b>Meus Anúncios</b></h2>
					</div>

					<div class="col-sm-7">
						<a href="/Newcadastrarservico" class="btn btn-primary"><i class="fas fa-plus"></i>  <span>Adicionar  novo  anúncio</span></a>
        ...
        ?>
						...
						<td>
                            ...
                            <a href="/meuservicos/apagar/{{ $acesso->id }}"
                               onclick="return confirm('Deseja realmente excluir o cliente: {{$acesso->name}}?');"
