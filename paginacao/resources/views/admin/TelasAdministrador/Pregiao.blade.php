    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-12">
						<h2>Controle <b>de Anúncios por Região</b></h2>
					...
					<div class="col-sm-7">
                     ...
                     <div class="alert alert-info">
                       <p>Quais as regiões do Brasil Possuem mais anúncios </p>
                     </div>
        ...
        ?>
            ...
            <td>{{$estados->categoria }}</td>
            <td>

            <a  href="admin/navegando"
            class="view" title="Ver todos os Anúncios" data-toggle="tooltip"><i class="fas fa-eye"></i></a>
