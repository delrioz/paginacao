    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-5">
						<h2>Controle <b>de Categorias</b></h2>
					</div>
					<div class="col-sm-7">
						<a href="#" class="btn btn-primary" data-toggle="modal" data-target="#squarespaceModal"><i class="fas fa-plus"></i>  <span>Adicionar  Categoria</span></a>
        ...
        ?>
						...
						<td>
                          ...
                          <a href="/admin/categorias/editar/{{ $anuncio->id }}"
                            ...
                            <a href="/admin/categorias/apagar/{{ $anuncio->id }}"
                               onclick="return confirm('Deseja realmente excluir o cliente: {{$anuncio->name}}?');"
  ...
  <div class="modal-dialog">
	<div class="modal-content">
		...
		<div class="modal-body">
           ...
           <h1 style="color:#590670;">Cadastrar nova Categoria</h1>
              </div>
          ...
          <form method="POST" action="/admin/categorias/criar" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1"  name ="name" placeholder="Digite a categoria">
              </div>

              <div class="form-group">
                <label for="exampleInputEmail1">Sobre</label>
                <input type="text" class="form-control" id="exampleInputEmail1"  name ="sobre"placeholder="Fale sobre esta categoria">
              </div>
