...
<body>
    ...
    @endif
        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-5">
						<h2>Controle <b>de Clientes</b></h2>
					</div>
					<div class="col-sm-7">
						<a href="#" class="btn btn-primary" data-toggle="modal" data-target="#squarespaceModal"><i class="fas fa-plus"></i>  <span>Adicionar  novo usuário</span></a>
 ...
 ?>
						...
						<td>
							...
							<a  href="/admin/acessarclientes/editar/{{ $cliente->id }}"
                            ...
                            <a href="/admin/acessarclientes/apagar/{{ $cliente->id }}"
                               onclick="return confirm('Deseja realmente excluir o cliente: {{$cliente->name}}?');"
  ...
  <div class="modal-dialog">
	<div class="modal-content">
		...
		<div class="modal-body">
           ...
           <h1 style="color:#590670;">Cadastro de clientes</h1>
              </div>
