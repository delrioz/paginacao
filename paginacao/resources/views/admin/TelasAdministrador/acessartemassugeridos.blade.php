    ...
    <div class="container">
        ...
        <div class="table-wrapper">
            ...
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-5">
						<h2>Sugestões <b>de Categorias</b></h2>
                    </div>
            ...
            @foreach($sugestoes as $sugestao)
             ...
             ?>
						...
						<td>
							...
							<a  href="/admin/acessarsugestoes/visualizar/{{ $sugestao->id }}"
                             class="view" title="View" data-toggle="tooltip"><i class="fas fa-eye"></i></a>


                            <!-- <a href="/admin/acessarsugestaos/cadastrar/{{ $sugestao->id }}"
                             class="edit"
                             title="Edit"
                             data-toggle="tooltip"><i class="fas fa-user-edit"></i></a>
                              -->

                            <a href="/admin/acessarsugestoes/apagar/{{ $sugestao->id }}"
                               onclick="return confirm('Deseja realmente excluir o sugestao: {{$sugestao->categoria}}?');"
            ...
            <div class="clearfix">
                <div class="hint-text">Exibindo <b>{{ $sugestoes->count() }}
                              </b> de <b>{{$sugestoes->total()}}</b> Sugestões</div>
                              {{ $sugestoes->links() }}
            </div>
