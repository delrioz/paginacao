...
<body>
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    ...
                    e, através de qual publicação.</p> 
                    <p> Agrupando apenas por quantidade de cliques por anuncio's 
                     </p> 
                     <p>Desta forma mesmos anunciantes podem se repetir neste relatório, mas em diferentes anuncios que os mesmos publicaram</p>
        ...
        ?>
            ...
            <a  href="/admin/acessaranuncios/editar/{{$portifolios->anuncioId}}"
            class="view" title="Acessar Anúncios" data-toggle="tooltip"><i class="fas fa-eye"></i></a>
