    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-5">
						<h2>Controle <b>de Reportes</b></h2>
					</div>
					<div class="col-sm-7">
            ...
            $max = 17;
            $str = " $reports->moreAbout ";
            $sobre=  substr_replace($str, (strlen($str) > $max ? '...' : ''), $max);

            $str = " $reports->emailDeQmAnuncia ";
            $emailDeQmAnuncia=  substr_replace($str, (strlen($str) > $max ? '...' : ''), $max);
        ?>
            ...
            <td></td>
                        ...
                        <td>{{$resultName}}</td>
                        <td>{{$sobre}}</td>
                        <td>{{$emailDeQmAnuncia}}</td>
                        <td>{{$reports->created_at}}</td>


						<td>

              <a href="/admin/reports/editar/{{ $reports->id }}"
