...
class profileUpdateValidationFormRequest extends FormRequest
{      

    public function authorize()
    {
        return true;  // onde podemos definir quem tem acesso a esses métodos ou não
    }
    ...
    public function rules()
    {
        return [
            ...
            'image' =>    'sometimes|file|image|max:552',
    ...
    public function messages()
    {
        return[
          ...
          'categoria.max' => 'O campo categoria só aceita no máximo 120 caracteres!',
          ...
          'endereco.min' => 'O endereço deve conter no máximo 5 caracteres',
          ...
          'bairro.min' => 'O campo bairro  deve conter no mínimo 3 caracteres!',
